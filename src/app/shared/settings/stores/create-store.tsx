...
import {
  StoreFormInput,
  storeFormSchema,
} from '@/utils/validators/create-store.schema';
                ...
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <Select
                      ...
                      error={errors?.managers?.message as string}
