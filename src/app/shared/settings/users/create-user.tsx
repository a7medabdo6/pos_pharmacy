...
import {
  UsersFormInput,
  usersFormSchema,
} from '@/utils/validators/create-users.schema';
...
export default function Createusers({
  ...
  id?: string;
  isModalView?: boolean;
  category?: UsersFormInput;
}) {
  const [reset, setReset] = useState({});
  const [isLoading, setLoading] = useState(false);

  const onSubmit: SubmitHandler<UsersFormInput> = (data) => {
          ...
          <div className="flex-grow pb-10">
            ...
            >
              <HorizontalFormBlockWrapper
                title={'Add new User:'}
                description={'Edit your User information from here'}
