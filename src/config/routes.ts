export const routes = {
  eCommerce: {
    ...
    storeCreate: '/settings/stores/create',

    user: '/settings/users',
    UserCreate: '/settings/users/create',
    unit: '/settings/unites',
    unitCreate: '/settings/unites/create',

    suppliers: 'suppliers/suppliers',
    suppliersCreate: '/suppliers/create',

    salePoint: '/settings/sale-points',
    salePointCreate: '/settings/sale-points/create',
  },
  support: {
    dashboard: '/support',
    inbox: '/support/inbox',
